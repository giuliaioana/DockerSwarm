...
rabitmq_host = "ip-172-31-42-104" if os.getenv("SWARM") else "rabbitmq"
...
api.config['SQLALCHEMY_DATABASE_URI'] = f"""mysql://{settings.user}:{get_db_password().rstrip()}@{host}/{settings.db}"""
